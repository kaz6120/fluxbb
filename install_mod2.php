...
function install()
{
	...
	foreach ($config as $conf_name => $conf_value)
	{
		$db->query('INSERT INTO '.$db->prefix."config (conf_name, conf_value) VALUES('$conf_name', $conf_value)")
			or error('Unable to insert into table '.$db->prefixx.'config. Please check your configuration and try again', __FILE__, __LINE__, $db->error());
	}
	...
	$p_subject = 'Congratulations!';
	
	$p_message = 'If you are looking at this (which I guess you are), the install of Another Private Messaging/Topic System 2.x appears to have worked! Thanks for installing this mod, I hope you\'ll enjoy it! adaur';
