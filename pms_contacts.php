...
?>
	...
	<?php
		...
		{
			echo '<td><a href="profile.php?id='.$cur_contact['contact_id'].'"><strong>'.pun_htmlspecialchars($cur_contact['contact_name']).'</strong></a></td>';
		}
		else
		{
			echo '<td><strong>'.pun_htmlspecialchars($cur_contact['contact_name']).'</strong></td>';
		}
	?>
