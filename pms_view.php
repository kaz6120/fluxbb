...
<div class="linkst">
	<div class="inbox crumbsplus">
		<ul id="crumbs-top">
			...
			<li><?php echo $lang_pms['Delete message'] ?></li>
		</ul>
...
$reply_link = '<p class="postlink conr"><a href="pms_send.php?reply='.$tid.'">'.$lang_pms['Reply'].'</a></p>';
?>
<div class="linkst">
	<div class="inbox crumbsplus">
		<ul id="crumbs-top">
			...
			<li><a href="pms_inbox.php"><?php echo $lang_pms['Private Messages'] ?></a></li>
			<li><a href="pms_inbox.php"><?php echo $lang_pms['Inbox'] ?></a></li>
			<li><a href="#block"><?php echo $lang_pms['View'] ?></a></li>
			<li><?php echo $messageh2 ?></li>
		</ul>
		<div class="pagepost"></div>
		<div class="clearer"></div>
	</div>
...
<div class="block2col">
	...
	<div class="block" id="block">
		<div class="pagepost">
			<p class="pagelink conl"><span class="pages-label"><?php echo $lang_common['Pages'].' '.paginate($num_pages, $p, 'pms_view.php?tid='.$tid.'&amp;mid='.$mid)  ?></span></p>	
